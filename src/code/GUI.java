...
public abstract class GUI {
	...
	//Is called when articulation points button is pressed;
	protected abstract void showArtPts();
	...
	private void initialise() {
		...
		JButton artPoints = new JButton("Show Articulation Points");
